    ...
    methods: {
      ...
      setGrade: function(){
        ...
        if(eventCradeArray.length == 0){
          ...
          this.f.eventGrade = eventCradeArray[eventCradeArray.length-1].key;
          this.f.eventGradeName = eventCradeArray[eventCradeArray.length-1].text;
      ...
      subButtonClick: function () {
        ...
        // 提交附件
        this.uploadAttach(function(list){
          if(list.length > 0){
